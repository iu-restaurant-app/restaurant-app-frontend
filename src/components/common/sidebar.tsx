...
// taken from https://flowbite.com/docs/flowbite-components/sidebar
export default function Sidebar(props: SidebarProps) {
  return (
    <div
      id="drawer-navigation"
      className={`fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform ${props.isOpen ? '' : '-translate-x-full'} bg-white`}
      tabIndex={-1}
