...
const MenuSearchAdmin: React.FC<MenuSearchProps> = ({ onSearchChange }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row mx-[70px] items-center">
      ...
      <div className="p-8 md:w-1/2 flex flex-col md:flex-row items-center md:justify-between">
        <div className="flex justify-end md:justify-start">
          <button
            className="bg-default-600 hover:bg-green-800 text-white font-bold py-4 px-4 rounded-lg mb-4 md:mb-0 md:mr-4 transition-colors duration-300 ease-in-out whitespace-nowrap"
        ...
        <form className="w-full md:w-auto" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            ...
            <input
              type="search"
              id="default-search"
              className="block w-full md:w-96 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-default-600 focus:border-default-600 outline-0"
