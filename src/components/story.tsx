...
export default function Story() {
  return (
    <div>
      ...
      <section className="@apply w-full min-h-[50vh] bg-red-900">
        <br />
        <h1 className="text-center text-5xl text-white font-serif">
          Our story
        </h1>
        <br />
      ...
      <section className="@apply w-full min-h-[100vh] bg-red-900">
        <br />
        <h1 className="text-center text-5xl text-white font-serif">
          Our kitchen
        </h1>
        ...
        <div className="@apply w-full min-h-[61vh] bg-orange-700 bg-opacity-0 text-center">
          <Image
            className="rounded-full w-96 h-96 justify-center mt-8 m-auto"
            src={pastaEgg}
          ...
          <p className="m-auto text-center font-serif w-[55%] text-2xl text-white mb-16">
            ...
            chefs meticulously select the freshest ingredients to craft each
            dish with care and precision.
          </p>
        </div>

        <div className="@apply w-full min-h-[78vh] bg-yellow-50 text-center">
          <br />
          <Image
            className="rounded-full w-96 h-96 mt-12 m-auto"
            src={pasta}
            alt="Pasta cutting"
          />
          <br />
          <p className="m-auto text-center font-serif w-[55%] text-2xl text-grey-700">
            With a focus on authentic recipes and time-honored cooking
            techniques, every bite is a symphony of flavors that transport you
            to the streets of Italy.
          </p>
        </div>
        <div className="@apply w-full min-h-[75vh] bg-lime-200">
          <br />
          <Image
            className="rounded-full w-96 h-96 mt-12 m-auto"
            src={pastaReady}
          ...
          <p className="m-auto text-center font-serif w-[55%] text-2xl text-red-900">
            ...
            celebration of taste that will leave you craving more. Come savor
            the true essence of Italy with us and experience the unparalleled
            quality and deliciousness of our dishes.
          </p>
          <br />
        </div>
      </section>
      ...
      <section className="@apply flex min-h-screen flex-col items-center justify-center bg-fixed bg-yellow-50 bg-center bg-cover text-black] gap-y-16 text-center">
        <h1 className="text-5xl text-red-900 font-serif align-text-top">
          Our atmosphere
        </h1>
        <Carousel data={DATA} />
      </section>
